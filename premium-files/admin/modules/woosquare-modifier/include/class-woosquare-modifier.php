...
/*print_r($_POST['modifier_set_name']);*/
	...
	public function deleteModifier($id) {
		...
		global $wpdb;
		$object_id = $wpdb->get_row(("SELECT modifier_set_unique_id FROM " . $wpdb->prefix . "woosquare_modifier WHERE modifier_id = '$id'"));
						...
						<table class="widefat attributes-table wp-list-table ui-sortable" style="width:100%">
							...
							if ( $modifier_taxonomies ) :
								foreach ( $modifier_taxonomies as $modifier ) :
									...
									<tr>
										<td>
											<strong><a href="edit-tags.php?taxonomy=<?php echo esc_attr( self::wsm_modifier_set_name( $modifier->modifier_slug."_".$modifier->modifier_id) ); ?>&amp;post_type=product"> <?php echo  esc_html($modifier->modifier_set_name)  ?></a></strong>
